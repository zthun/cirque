...
export const ZCircusKeyboardQwerty = Object.freeze({
  ...
  backquote: new ZCircusKeyBuilder("`", "Backquote")
    .upper("~")
    .printable()
    .build(),
  ...
  bracketLeft: new ZCircusKeyBuilder("[", "BracketLeft")
    .upper("{")
    .printable()
    .build(),
  bracketRight: new ZCircusKeyBuilder("]", "BracketRight")
    .upper("}")
    .printable()
    .build(),
  backslash: new ZCircusKeyBuilder("\\", "Backslash")
    .upper("|")
    .printable()
    .build(),

  capsLock: new ZCircusKeyBuilder("CapsLock", "CapsLock")
    .shift()
    .toggle()
    .build(),
  ...
  semiColon: new ZCircusKeyBuilder(";", "Semicolon")
    .upper(":")
    .printable()
    .build(),
  ...
  shiftLeft: new ZCircusKeyBuilder("Shift", "ShiftLeft")
    .modifier()
    .shift()
    .build(),
  ...
  shiftRight: new ZCircusKeyBuilder("Shift", "ShiftRight")
    .modifier()
    .shift()
    .build(),

  controlLeft: new ZCircusKeyBuilder("Control", "ControlLeft")
    .modifier()
    .build(),
  ...
  controlRight: new ZCircusKeyBuilder("Control", "ControlRight")
    .modifier()
    .build(),
  ...
  numpadDecimal: new ZCircusKeyBuilder(".", "NumpadDecimal")
    .printable()
    .build(),
