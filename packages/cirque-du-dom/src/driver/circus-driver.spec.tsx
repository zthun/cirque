import { IZCircusDriver, IZCircusSetup, ZCircusActBuilder, ZCircusWaitOptionsBuilder } from '@zthun/cirque';
import { afterEach, describe, expect, it } from 'vitest';
import { ZCircusSetupHtml } from '../setup/circus-setup-html';
...
describe('ZCircusDriver (DOM)', () => {
  ...
  const createTestTarget = async () => {
    ...
    _setup = new ZCircusSetupHtml(html);
  ...
  describe('Monkey patches', () => {
    it('should enable the getBoundingClientRect on the element', async () => {
      ...
      const element = (_driver as ZCircusDriver).element;
      // Act.
